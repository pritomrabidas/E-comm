    ...
    <div className="mt-12 bg-[#F6F7F8] py-5 px-4 rounded">
      ...
      <div className="flex justify-between font-normal font-Poppins text-lg text-secondary ">
        <ul className="HotDeal">
            ...
            <li className="pb-4">Nike</li>
            <li className="pb-4">Addidas</li>
            <li className="pb-4">All Star</li>
            <li className="pb-4">Vans</li>
        </ul>
        <ul>
            <li className="pb-4">2</li>
            <li className="pb-4">20</li>
            <li className="pb-4">2</li>
            <li className="pb-4">36</li>
            <li className="pb-4">40</li>
            <li className="pb-4">50</li>
        </ul>
      </div>
    </div>
  )
